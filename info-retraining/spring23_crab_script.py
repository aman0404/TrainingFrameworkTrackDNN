...
datasets = {
            "TT_new":"/TT_TuneCP5_14TeV-powheg-pythia8/Phase2Spring23DIGIRECOMiniAOD-PU200_131X_mcRun4_realistic_v5-v1/GEN-SIM-DIGI-RAW-MINIAOD",
            ...
            #"TT":"/TT_TuneCP5_14TeV-powheg-pythia8/Phase2Spring23DIGIRECOMiniAOD-PU200_Trk1GeV_131X_mcRun4_realistic_v5-v1/GEN-SIM-DIGI-RAW-MINIAOD",
...
config = config()
config.General.workArea        = 'crab_spring23_trackingNtuple'
config.General.transferOutputs = True
config.General.transferLogs    = False
config.Data.ignoreLocality  = True
config.JobType.sendExternalFolder = True
config.JobType.pluginName  = 'Analysis'
config.JobType.psetName    = 'cuts_v2_Spring23_trackNtuple_producer.py'
config.JobType.numCores    = 4
config.JobType.maxMemoryMB = 8000
config.Data.splitting   = 'EventAwareLumiBased'
config.Data.unitsPerJob = 40#20
config.Data.totalUnits  = -1#40
config.Data.outLFNDirBase = '/store/user/amkaur/tkNtuple-General-MKFIT-phase2-CMSSW131X_cuts/'
...
config.General.requestName     =  key+"--withQualityCuts_v2"
